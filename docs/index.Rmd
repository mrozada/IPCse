...
year_t <- as.numeric(read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
    sheet = "Cuadro1", range = "c4", col_names = FALSE))

mes_t <- as.numeric(read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
    sheet = "Cuadro1", range = "k4", col_names = FALSE))

mes_tm1 <- as.numeric(read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
...
meses <- read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
...
cuadro1 <- read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
...
cuadro2 <- read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
                      sheet = "Cuadro2", 
                      range = "D13:K46")

## Importo los datos de figura 1

figura1 <- read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
                      sheet = "Figura1", 
                      range = "D47:G61")

## Importo los datos de figura 2

figura2 <- read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
                      sheet = "Figura1", 
                      range = "D63:F87")

## Importo los datos de figura 3
figura3 <- read_excel("C:/Users/fiona/Dropbox/MGR/IPC seasonal adjustment/IPCse/IPCse.xlsx", 
                      sheet = "LinePlot", 
                      range = "A1:C2000")
