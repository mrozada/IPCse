...
En `r meses[mes_t,1]` los factores estacionales contribuyeron a que la medición oficial de la inflación fuera `r text1` que sin estacionalidad, `r fg3t[1,2]` por ciento versus `r fg3t[1,3]` por ciento. Esta diferencia de `r abs(dif_indec_ipcse)` puntos porcentuales en la inflación con estacionalidad de `r meses[mes_t,1]` se explica fundamentalmente por el comportamiento de las divisiones de Prendas de vestir y calzado y Educación, donde los factores estacionales hicieron que la medición oficial fuera entre 1.3 y 2.5 puntos porcentuales más baja (Figura 2). Durante los últimos 12 meses, el índice aumentó un `r cuadro1[2,8]` por ciento antes del ajuste estacional (datos oficiales de INDEC). <br>

**Durante `r meses[mes_t,1]`, el comportamiento del IPCse nivel general fue impulsado por casi todas las regiones. En la región de Patagonia se registró la mayor diferencia entre la medición oficial y el índice sin estacionalidad. Esta diferencia fue de 0.4 puntos porcentuales.** El resto de las regiones registraron una medición sin estacionalidad mayor a la medición oficial, aunque con diferencias entre 0.2 y 0.4 puntos porcentuales, a excepción de la región Noreste, donde la medición sin estacionalidad fue 0.3 puntos porcentuales más baja que la medición oficial (Figura 1).<br>

**El índice de precios de Bienes y servicios varios fue el que más aumentó en el mes, con un incremento de `r cuadro1[20,7]` por ciento, seguido inmediatamente del índice de Salud, cuyo incremento fue de `r cuadro1[14,7]`.** También destacan los aumentos en Transporte, Equipamento y mantenimiento del hogar, y Alimentos y bebidas no alcohólicas, con `r cuadro1[14,7]`, `r cuadro1[13,7]` y `r cuadro1[9,7]` por ciento respectivamente (Cuadro 1).<br>

**El índice de precios de Educación fue el que menos aumentó en la medición sin estacionalidad, con un aumento de `r cuadro1[18,7]` por ciento.** En particular, fue el único que no superó el 10 por ciento mensual. El siguiente índice con el aumento más bajo fue el de Vivienda, agua, gas, electricidad y otros combustibles, registrando una suba de `r cuadro1[12,7]` por ciento. (Figura 2).<br>

**La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división Alimentos y bebidas no alcohólicas explicando alrededor de `r round(100*cuadro2[5,8]/cuadro2[2,8],0)` por ciento del `r cuadro1[2,7]` por ciento de inflación.**  El índice de precios de la división Alimentos y bebidas no alcohólicas contribuyó a explicar el 43 y 45 por ciento de la inflación sin estacionalidad en las regiones Noroeste y Noreste, respectivamente. En la región del Gran Buenos Aires la división de alimentos y bebidas no alcohólicas explicó el 32 por ciento del incremento en el IPCse regional. Las otras divisiones con incidencias importantes en el aumento del nivel general de precios sin estacionalidad fueron las de Transporte y Salud, explicando 3.2 y 2.8  puntos porcentuales cada una, representando alrededor de un 11 y 12 por ciento de la inflación sin estacionalidad. (Cuadro 2).<br>

**En la comparación interanual, `r meses[mes_t,1]` de `r year_t` contra `r meses[mes_t,1]` de `r year_t - 1` antes del ajuste estacional, más del 50 por ciento del aumento de `r cuadro1[2,8]` por ciento está explicado por los índices de precios de tres de las divisiones de la canasta: Alimentos y bebidas no alcohólicas, Prendas de vestir y calzado, y Restaurantes y hoteles.** Transporte, con una incidencia interanual de `r sprintf("%.1f", cuadro2[28,8])` puntos porcentuales, y Salud, con `r sprintf("%.1f",cuadro2[27,8])` puntos porcentuales, son las divisiones que le siguen en la explicación del aumento interanual del nivel general de precios sin estacionalidad. En diciembre, a diferencia de meses anteriores, se observa que estas dos divisiones acumularon una contribución que es relativametne mayor a la de meses anteriores, con incidencias comparables a las de Prendas de vestir y calzado o Restaurantes y hoteles (Cuadro 2).<br>

**En `r meses[mes_t,1]`, la inflación subyacente, definida como el cambio porcentual en el nivel general del IPCse menos el efecto de los índices de precios de las divisiones de la canasta que incluyen bienes y servicios regulados o con alto componente impositivo, fue de `r cuadro1[21,7]` por ciento después de haber aumentado un `r cuadro1[21,6]` por ciento en `r meses[mes_t-1,1]`.** El valor de `r meses[mes_t,1]` es una combinación de valores relativamente menores en la región Patagonia, con un `r cuadro1[27,7]` por ciento, y un valor relativamente más alto en la región Noreste, alcanzando un `r cuadro1[25,7]`. En términos interanuales, la inflación subyacente en el país se ubica en `r sprintf("%.1f", cuadro1[21,8])` por ciento en `r meses[mes_t,1]` (Cuadro 1).
...
La Figura 4 muestra las diferencias entre las contribuciones a la tasa de inflación interanual de `r meses[mes_t,1]` del 20 por ciento de los hogares de menores y mayores ingresos. **La división de Alimentos y bebidas no alcohólicas contribuyó a incrementar más la inflación para los hogares de menores ingresos en comparación con los hogares de mayores ingresos.** En particular, esta división explicó más de 50 puntos porcentuales de diferencia. En comparación, Transporte, Salud, y Restaurantes y hoteles fueron las divisiones que contribuyeron para aumentar más la tasa de inflación que enfrentó el grupo de hogares de mayores ingresos en comparación con los hogares de menores ingresos. Estas tres divisiones contribuyeron a reducir la brecha en la inflación enfrentada por los hogares de menores y mayores ingresos en casi 30 puntos porcentuales.
