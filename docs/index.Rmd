...
En `r meses[mes_t,1]` los factores estacionales contribuyeron a que la medición oficial de la inflación fuera `r text1` que sin estacionalidad, `r fg3t[1,2]` por ciento versus `r fg3t[1,3]` por ciento. Esta diferencia de `r abs(dif_indec_ipcse)` puntos porcentuales en la inflación con estacionalidad de `r meses[mes_t,1]` se explica fundamentalmente por el comportamiento de las divisiones de Prendas de vestir y calzado y Educación, donde los factores estacionales hicieron que la medición oficial fuera entre 1.3 y 2.3 puntos porcentuales más baja (Figura 2). Durante los últimos 12 meses, el índice aumentó un `r cuadro1[2,8]` por ciento antes del ajuste estacional (datos oficiales de INDEC). <br>

**Durante `r meses[mes_t,1]`, el comportamiento del nivel general del IPCse fue parejo en casi todas las regiones; en casi todas se registró una medición oficial que fue entre 0.1 y 0.3 menor que la medición sin estacionalidad, a excepción de las regiones Pampeana y Cuyo, en donde se registraron mediciones oficiales iguales y 0.1 puntos porcentuales mayores a la medición oficial, respectivamente.** Las regiones GBA y Patagonia fueron las regiones con mayor diferencia, con 0.3 puntos porcentuales de diferencia en cada una. (Figura 1).<br>

**El índice de precios de Comnicación fue, con diferencia, el que más aumentó en el mes, con un incremento de `r cuadro1[16,7]` por ciento, seguido del índice de Transporte, cuyo incremento fue de `r cuadro1[15,7]`.** También fueron notorios los aumentos en Vivienda, agua, electricidad, gas y otros combustibles, Bebidas alcohólicas y tabaco, y Bienes y servicios varios con `r cuadro1[12,7]`, `r cuadro1[10,7]` y `r cuadro1[20,7]` por ciento respectivamente (Cuadro 1).<br>

**El índice de precios de Recreación y cultura y el de Prendas de vestir y calzado fueron los que menos aumentaron en la medición sin estacionalidad, con un aumento de `r cuadro1[17,7]` por ciento.**  (Figura 2).<br>

```{r cuadrito_incidencias_mensual, include=FALSE}
arrange(cuadro2[5:16,],desc(Nacional))
```

**La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división Alimentos y bebidas no alcohólicas explicando alrededor de `r round(100*cuadro2[5,8]/cuadro2[2,8],0)` por ciento del `r cuadro1[2,7]` por ciento de inflación.**  El índice de precios de la división Alimentos y bebidas no alcohólicas contribuyó a explicar alrededor de un 30 por ciento de la inflación sin estacionalidad en las regiones Noreste y Noroeste, respectivamente. En la región del Gran Buenos Aires la división de Alimentos y bebidas no alcohólicas explicó el 23.5 por ciento del incremento en el IPCse regional. Durante el mes de febrero, la división de Transporte tuvo un peso considerable en el dato de inflación, explicando  un 18 por ciento de la cifra para todo el país. El efecto de esta división es dispar entre regiones, alcanzando un 22 por ciento en GBA, pero entre 12 y 16 por ciento para el resto de las regiones. También fue considerable el aumento explicado por las divisiones de Salud y de Vivienda, agua, electricidad, gas y otros combustibles.  (Cuadro 2).<br>
...
La Figura 3 muestra la diferencia entre la inflación anual experimentada por el 20 por ciento de la población de menores ingresos y el 20 por ciento de mayores ingresos (medido por el ingreso familiar per capita del hogar). Durante el mes de febrero, el comportamiento de las tasas de inflación interanuales experimentadas por los hogares de mayores y menores ingresos quebró la tendienca iniciada en agosto del año pasado. **En particular, durante `r meses[mes_t,1]`, la brecha se ubicó en 0.3 puntos porcentuales, acortando prácticamente toda la diferencia presente entre la tasa de inflación que experimentan los hogares de mayores y menores ingresos.**. Este comportamiento se explica por el cambio abrupto en las tasas de inflación interanuales de las divisiones en las que los hogares de mayores ingresos consumen más, como Transporte, Bienes y servicios varios, Vivienda, agua, electricidad, gas y otros combustibles y Salud, contra los cambios no tan grandes en la tasa de inflación interanual de Alimentos y Bebidas no alcohólicas y Prendas de vestir y calzado.
...
El Cuadro 4 muestra el impacto diferencial de la inflación por quintiles de ingreso per cápita familiar para los datos oficiales. **Los hogares de menores ingresos, quintil 1, enfrentaron en marzo una inflación de `r sprintf("%.1f",cuadro4[1,3])` por ciento comparada con una inflación de `r sprintf("%.1f",cuadro4[5,3])` por ciento para los hogares del 20 por ciento de mayores ingresos.** Los hogares del quintil 1 enfrentaron una inflación de `r sprintf("%.2f",cuadro4[1,3])` por ciento, comparada con una inflación de `r sprintf("%.2f",cuadro4[5,3])` por ciento para el quintil 5 (ver Figura 5). Esta diferencia se debe fundamentalmente al menor aumento relativo de los precios de las divisiones de Alimentos y bebidas no alcohólicas y Prendas de vestir y calzado, que impactan en mayor medida en los hogares de menores ingresos (quintil 1), junto con los mayores aumentos relativos de los precios de las divisiones de Transpore, Salud, y Bienes y servicios varios, que impactan más en los hogares de mayores ingresos (quintil 5).
