...
En `r meses[mes_t,1]` los factores estacionales contribuyeron a que la medición oficial de la inflación fuera `r text1` que sin estacionalidad, `r fg3t[1,2]` por ciento versus `r fg3t[1,3]` por ciento. Esta diferencia de `r abs(dif_indec_ipcse)` puntos porcentuales en la inflación con estacionalidad de `r meses[mes_t,1]` se explica fundamentalmente por el comportamiento de las divisiones de Prendas de vestir y calzado y Vivienda, agua, electricidad, gas y otros combustibles, donde los factores estacionales hicieron que la medición oficial fuera 2.3 puntos porcentuales más alta para la primera y 0.2 puntos más alta para la segunda (Figura 2). Durante los últimos 12 meses, el índice aumentó un `r cuadro1[2,8]` por ciento antes del ajuste estacional (datos oficiales de INDEC). <br>

```{r, include=FALSE}
fg2_wide %>%  arrange(desc(Diferencia))
```

**Durante `r meses[mes_t,1]`, el comportamiento del nivel general del IPCse fue parejo en casi todas las regiones; las diferencias entre la medición oficial y la medición sin estacionalidad  estuvieron entre 0 y 0.1 puntos porcentuales.** Las regiones con mayor diferencia fueron las regiones Pampeana, Noroeste y Cuyo, con 0.1 puntos porcentuales de diferencia (Figura 1).<br>

```{r, include=FALSE}
fg1t_wide %>%  arrange(desc(Diferencia))
```

**El índice de precios de Vivienda, agua, electricidad, gas y otros combustibles fue, con diferencia, el que más aumentó en el mes, con un incremento de `r cuadro1[12,7]` por ciento, seguido del índice de Comunicación, cuyo incremento fue de `r cuadro1[16,7]`.** En un segundo escalón, los índices de Educación y Salud tuvieron aumentos de `r cuadro1[18,7]` y `r cuadro1[14,7]` por ciento respectivamente (Cuadro 1).<br>

```{r, include=FALSE}
fg2_wide %>%  arrange(desc(IPCse))
```

**El índice de precios de Bienes y servicios varios fue el que menos aumentó en la medición sin estacionalidad, con una suba de `r cuadro1[20,7]` por ciento,**  seguido del índice de precios de Alimentos y bebidas no alcohólicas, cuyo aumento en la medición sin estacionalidad fue de `r cuadro1[9,7]`  (Figura 2).<br>

```{r cuadrito_incidencias_mensual, include=FALSE}
arrange(cuadro2[5:16,],desc(Nacional))
```

**La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división Vivienda, agua, electricidad, gas y otros combustibles explicando alrededor de `r round(100*cuadro2[8,8]/cuadro2[2,8],0)` por ciento del `r cuadro1[2,7]` por ciento de inflación.**  El índice de precios de la división Vivienda, agua, electricidad, gas y otros combustibles contribuyó a explicar un 29 por ciento de la inflación sin estacionalidad en las regiones GBA y Patagonia. El porcentaje del dato de inflación mensual explicado por esta división en otras regiones se ubica entre 12 y 23 por ciento. Durante `r meses[mes_t,1]` la división de Alimentos y bebidas no alcohólicas tomó el segundo lugar en la incidencia, explicando un 22 por ciento de la cifra para todo el país. En las regiones del norte del país, esta división explicó entre un 30 y 33 por ciento de la cifra de inflación mensual, pero alcanzó sólo un 17 por ciento en el Gran Buenos Aires. También fue considerable el aumento explicado por las divisiones de Salud, explicando casi un 10 por ciento de la tasa de inflación sin estacionalidad a nivel nacional.  (Cuadro 2).<br>
