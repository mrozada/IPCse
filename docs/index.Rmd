...
En `r meses[mes_t,1]` los factores estacionales contribuyeron a que la medición oficial de la inflación fuera `r text1` que sin estacionalidad, `r fg3t[1,2]` por ciento versus `r fg3t[1,3]` por ciento. Esta diferencia de `r abs(dif_indec_ipcse)` puntos porcentuales en la inflación con estacionalidad de `r meses[mes_t,1]` se explica fundamentalmente por el comportamiento de las divisiónes de Alimentos y bebidas no alcohólicas, Prendas de vestir y calzado, Comunicación y Recreación y cultura, donde los factores estacionales hicieron que la medición oficial fuera entre 0.3 y 0.7 puntos porcentuales más alta (Figura 2). La diferencia en estas divisiones fue parcialmente compensada por una medición oficial 0.5 puntos porcentuales menor que la medición sin estacionalidad en la división de Educación. Durante los últimos 12 meses, el índice aumentó un `r cuadro1[2,8]` por ciento antes del ajuste estacional (datos oficiales de INDEC). <br>

**Durante `r meses[mes_t,1]`, el comportamiento estacional del nivel general fue impulsado por las regiones Gran Buenos Aires (GBA), Noreste y Patagonia, donde la medición oficial fue 0.4 puntos porcentuales mayor al índice sin estacionalidad.** El resto de las regiones registraron una medición sin estacionalidad menor a la medición oficial, con diferencias entre 0.1 y 0.3 puntos porcentuales. (Figura 1).<br>

**El índice de precios de Comunicación fue, con diferencia, el que más aumentó en el mes, con un incremento de `r cuadro1[16,7]` por ciento.** En un segundo escalón estuvieron los incrementos en Equipamiento y mantenimiento del hogar, con `r cuadro1[13,7]` por ciento y en Prendas de vestir y calzado, con `r cuadro1[11,7]` por ciento (Cuadro 1).<br>

**Los índices de precios de Salud, junto con los de Alimentos y bebidas no alcohólicas, Educación y Transporte,  fueron los que menos aumentaron en la medición sin estacionalidad, con un aumentos de `r cuadro1[14,7]` por ciento para el primero y de `r cuadro1[9,7]`, `r cuadro1[15,7]` y `r cuadro1[15,7]` por ciento, respectivamente,  para los últimos.** Los índices de Salud y Transporte no muestran diferencias entre la medición sin estacionalidad y la medición de INDEC, mientras que para Alimentos y bebidas no alcohólicas las mediciones de INDEC fue 0.7 puntos porcentuales menor que la del IPCse. El índice de precios de Educación registró una diferencia de 0.5 puntos porcentuales con la medición sin estacionalidad, alcanzando una suba `r cuadro1[18,7]` puntos porcentuales contra el 6.6 de la medición oficial (Figura 2).<br>

**La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división alimentos y bebidas no alcohólicas explicando alrededor de `r round(100*cuadro2[5,8]/cuadro2[2,8],0)` por ciento del `r cuadro1[2,7]` por ciento de inflación.** Las otras divisiones con incidencias importantes en el aumento del nivel general de precios sin estacionalidad fueron las de Prendas de vestir y calzado, y Transporte, explicando 1.3 puntos porcentuales cada una. El índice de precios de la división Alimentos y bebidas no alcohólicas contribuyó a explicar el 33.8 y 30.0 por ciento de la inflación sin estacionalidad en las regiones Noroeste y Noreste, respectivamente. En la región del Gran Buenos Aires la división de alimentos y bebidas no alcohólicas explicó el 24.4 por ciento del incremento en el IPCse regional (Cuadro 2).<br>
...
La Figura 4 muestra las diferencias entre las contribuciones a la tasa de inflación interanual de `r meses[mes_t,1]` del 20 por ciento de los hogares de menores y mayores ingresos. **La división de alimentos y bebidas no alcohólicas contribuyó a incrementar más la inflación para los hogares de menores ingresos en comparación con los hogares de mayores ingresos.** En particular, esta división explicó más de 30 puntos porcentuales de diferencia. En comparación, Transporte, Restaurantes y hoteles y Salud, fueron las divisiones que contribuyeron para aumentar más la tasa de inflación que enfrentó el grupo de hogares de mayores ingresos en comparación con los hogares de menores ingresos. Las divisiones de Transporte y Restaurantes y hoteles contribuyeron a reducir la brecha en la inflación enfrentada por los hogares de menores y mayores ingresos en 14 puntos porcentuales.
