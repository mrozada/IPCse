...
**Durante `r meses[mes_t,1]`, todas las regiones registraron una tasa de inflación oficial menor a la medición sin estacionalidad, con diferencias entre 0.3 y 0.6 puntos porcentuales.** La mayor diferencia se dio en la región GBA, donde la tasa de inflación oficial fue 0.6 puntos porcentuales más baja que la medición sin estacionalidad, seguida de las regiones Patagonia y Noroeste. La región Noreste fue la única que registró una medición oficial de inflación mayor a la medición sin estacionalidad (Figura 1).<br>

```{r, include=FALSE}
fg1t_wide %>%  arrange(desc(Diferencia))
```

**El índice de precios de Educación fue el que más aumentó en el mes, con un incremento de `r cuadro1[18,7]` por ciento. En segundo lugar en los aumentos está el índice de precios sin estacionalidad de Vivienda, agua, electricidad, gas y otros combustibles, cuyo incremento fue de `r cuadro1[12,7]` por ciento.** En un segundo escalón, todos con aumentos de 4.5 por ciento, se ubican los aumentos en los índices de precios de Prendas de vestir y calzado, Comunicación y Restaurantes y hoteles.  (Cuadro 1).<br>

```{r, include=FALSE}
fg2_wide %>%  arrange(desc(IPCse))
```

**El índice de precios de Equipamiento y mantenimiento del hogar fue el que menos aumentó en la medición sin estacionalidad, con una suba de `r cuadro1[13,7]` por ciento, seguido del índice de precios de Salud, cuyo aumento en la medición sin estacionalidad fue de `r cuadro1[14,7]` por ciento** (Figura 2). <br>

```{r cuadrito_incidencias_mensual, include=FALSE}
arrange(cuadro2[5:16,],desc(Nacional))
```

**La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división Alimentos y bebidas no alcohólicas explicando alrededor de `r round(100*cuadro2[5,8]/cuadro2[2,8],1)` por ciento del `r cuadro1[2,7]` por ciento de inflación.** La incidencia de este índice fue alta en varias las regiones del país, explicando entre 16.0 por ciento en GBA y hasta 31.8 en la región Noroeste. Esta división fue la que más contribuyó a la tasa de inflación sin estacionalidad en casi todas las regiones, a excepción de GBA, donde Restaurantes y hoteles incidió 16.4 por ciento, y de la región Noreste, donde la incidencia de Transporte fue de 29.1 por ciento. Durante `r meses[mes_t,1]`, la segunda contribución más grande a la tasa de inflación mensual fue la del índice de Vivienda, agua, electricidad, gas y otros combustibles, explicando un 15.4 por ciento de la tasa de inflación mensual. Esta división no fue la de mayor incidencia en ninguna región, pero su incidencia estuvo entre 15 y 17 por ciento en casi todas las regiones a excepción de Cuyo y Noreste donde rondó el 10 por ciento  (Cuadro 2). La división Restaurantes y hoteles fue la tercera división con mayor incidencia, habiendo explicado 14.9 por ciento de la inflación mensual sin estacionalidad, con valores dispares entre regiones, explicando un 16.4 por ciento de la tasa de inflación mensual sin estacionalidad en GBA pero tan solo un 6.6 por ciento en la región Noreste . Estas tres divisiones explican la mitad de la inflación del mes de `r meses[mes_t,1]`. <br>
...
**En `r meses[mes_t,1]`, la diferencia entre la tasa de inflación mensual que enfrentaron los hogares de menores ingresos y la de mayores ingresos fue de `r sprintf("%.2f", abs(cuadro3se[1,3]-cuadro3se[5,3]))` puntos porcentuales en detrimento de los hogares de mayores ingresos.** Esta diferencia se explica por los menores aumentos en los índice de precios de Alimentos y bebidas no alcohólicas, donde los hogares de mayores ingresos (quintil 5) concentran una menor proporción de su gasto en comparación con la proporción del gasto total que le dedican los hogares de menores ingresos (quintil 1), junto con los mayores aumentos en las divisiones en las que concentran mayor proporción de sus gastos. Durante `r meses[mes_t,1]`, esto se vio reflejado principalmente en las divisiones de Restaurantes y hoteles, Educación y Salud.
