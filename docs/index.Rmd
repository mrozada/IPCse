...
### Inflación sin estacionalidad
  ...
  **El Índice de Precios al Consumidor nacional sin estacionalidad (IPCse) aumentó un `r cuadro1[2,7]` por ciento en `r meses[mes_t,1]`, luego de haber aumentado un `r cuadro1[2,6]` por ciento en `r meses[mes_tm1,1]`.** <br>
  ...
  En `r meses[mes_t,1]` los factores estacionales contribuyeron a que la medición oficial de la inflación fuera `r text1` que sin estacionalidad, `r fg3t[1,2]` por ciento versus `r fg3t[1,3]` por ciento. Esta diferencia de `r abs(dif_indec_ipcse)` puntos porcentuales en la inflación sin estacionalidad de `r meses[mes_t,1]` se explica fundamentalmente por el comportamiento de las divisiónes de Alimentos y bebidas no alcohólicas, Prendas de vestir y calzado y Recreación y cultura, donde los factores estacionales hicieron que la medición oficial fuera entre 0.2 y 0.6 puntos porcentuales más alta (Figura 2). Durante los últimos 12 meses, el índice aumentó un `r cuadro1[2,8]` por ciento antes del ajuste estacional (datos oficiales de INDEC). <br>
  
  
  **Durante `r meses[mes_t,1]`, el comportamiento estacional del nivel general fue impulsado por las regiones Noroeste y Patagónica donde la medición oficial fue 0.4 puntos porcentuales mayor al índice sin estacionalidad.** El impacto fue mayor en la región Noreste, donde la inflación ajustada por estacionalidad fue de 13.8 por ciento, mientras que la medición oficial fue de 14.2 por ciento. En la región Pampeana y en Cuyo la estacionalidad no tuvo ningún impacto. (Figura 1).<br>
  
  **El índice de precios de Alimentos y bebidas no alcohólicas fue, con diferencia, el que más aumentó en el mes con un incremento de `r cuadro1[9,7]` por ciento.** En un segundo escalón estuvieron los incrementos en Salud, con `r cuadro1[14,7]` por ciento y en Equipamiento y mantenimiento del hogar, con `r cuadro1[13,7]` por ciento (Cuadro 1).<br>
  
  **Los índices de precios de Comunicación y Educación son los que menos aumentaron en la medición sin estacionalidad, con aumentos de `r cuadro1[16,7]` y `r cuadro1[18,7]` por ciento, respectivamente.** El índice de Comunicación muestra una diferencia positiva de 0.5 puntos porcentuales entre la medición sin estacionalidad y la medición de INDEC, mientras que para Transporte no hubo diferencias entre la medición de INDEC y la del IPCse. El índice de precios de la división Bebidas alcohólicas y tabaco también se encuentra dentro de los que menos aumentaron en ambas mediciones, con una suba de  `r cuadro1[10,7]` por ciento (Figura 2).<br>
  
  **La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división alimentos y bebidas no alcohólicas explicando alrededor de `r round(100*cuadro2[5,8]/cuadro2[2,8],0)` por ciento del `r cuadro1[2,7]` por ciento de inflación.** Las otras divisiones con incidencias importantes en el aumento del nivel general de precios sin estacionalidad fueron las de Salud, y Restaurantes y hoteles, explicando 1.3 y 1.2 puntos porcentuales respectivamente. El índice de precios de la división alimentos y bebidas no alcohólicas contribuyó a explicar el 48.5 y 47.8 por ciento de la inflación sin estacionalidad en las regiones noroeste y noreste, respectivamente. En la región del Gran Buenos Aires la división de alimentos y bebidas no alcohólicas explicó el 32 por ciento del incremento en el IPCse regional (Cuadro 2).<br>
  
  **En la comparación interanual, `r meses[mes_t,1]` de `r year_t` contra `r meses[mes_t,1]` de `r year_t - 1` antes del ajuste estacional, más del 50 por ciento del aumento de `r cuadro1[2,8]` por ciento está explicado por los índices de precios de tres de las divisiones de la canasta: alimentos y bebidas no alcohólicas, prendas de vestir y calzado, y restaurantes y hoteles.**  Transporte con una incidencia interanual de 12.4 puntos porcentuales y Salud con 11.2 puntos porcentuales son las divisiones que le siguen en la explicación del aumento interanual del nivel general de precios sin estacionalidad (Cuadro 2).<br> 
  
  **En `r meses[mes_t,1]`, la inflación subyacente, definida como el cambio porcentual en el nivel general del IPCse menos el efecto de los índices de precios de las divisiones de la canasta que incluyen bienes y servicios regulados o con alto componente impositivo, fue de `r cuadro1[21,7]` por ciento después de haber aumentado un `r cuadro1[21,6]` por ciento en `r meses[mes_t-1,1]`**  El valor de `r meses[mes_t,1]` es una combinación de valores relativamente mayores en las regiones Noreste y Noroeste y valores relativamente más bajos en las regiones de GBA y Patagonia. En términos interanuales la inflación subyacente en el país ya superó el 122 por ciento en `r meses[mes_t,1]` (Cuadro 1).
...
<!-- de `r sprintf("%.1f",cuadro3se[5,4])` por ciento para el quintil de mayores ingresos  -->
  ...
  **En `r meses[mes_t,1]`, la diferencia entre la tasa de inflación mensual que enfrentaron los hogares de menores ingresos y la de mayores ingresos fue de `r sprintf("%.1f",cuadro3se[1,3]-cuadro3se[5,3])` puntos porcentuales.** Esta diferencia se explica casi totalmente por el mayor aumento relativo en el índice de precios de la división de alimentos y bebidas no alcohólicas donde los hogares de menores ingresos (quintil 1) concentran una mayor proporción de su gasto en comparación con la proporción del gasto total que le dedican los hogares de mayores ingresos (quintil 5).      
...
<br>
  ...
  La Figura 4 muestra las diferencias entre las contribuciones a la tasa de inflación interanual de `r meses[mes_t,1]` del 20 por ciento de los hogares de menores y mayores ingresos.  **La división de alimentos y bebidas no alcohólicas contribuyó a incrementar más la inflación para los hogares de menores ingresos en comparación con los hogares de mayores ingresos.** En particular esta división explicó más de 25 puntos porcentuales de diferencia. En comparación, Transporte, Restaurantes y hoteles y Salud, fueron las divisiones que contribuyeron para aumentar más la tasa de inflación que enfrentó el grupo de hogares de mayores ingresos en comparación con los hogares de menores ingresos. Las divisiones de transporte y restaurantes y hoteles contribuyeron a reducir la brecha en la inflación enfrentada por los hogares de menores y mayores ingresos en alrededor de 12 puntos porcentuales.  
