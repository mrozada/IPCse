...
En `r meses[mes_t,1]` los factores estacionales contribuyeron a que la medición oficial de la inflación fuera `r text1` que sin estacionalidad, `r fg3t[1,2]` por ciento versus `r fg3t[1,3]` por ciento. Estos 0.4 puntos porcentuales adicionales en la inflación sin estacionalidad de `r meses[mes_t,1]` se explican fundamentalmente por el comportamiento de las divisiones de alimentos y bebidas no alcohólicas, bebidas alcohólicas y tabaco, prendas de vestir y calzado y educación. Durante los últimos 12 meses, el índice aumentó un `r cuadro1[2,8]` por ciento antes del ajuste estacional (datos oficiales de INDEC). <br>


**Durante `r meses[mes_t,1]`, el comportamiento estacional fue parejo. En casi todas las regiones, la estacionalidad hizo que la medición oficial fuera de entre 0.3 y 0.5 puntos porcentuales mayor al índice sin estacionalidad.** El impacto fue mayor en la región de Gran Buenos Aires, donde la inflación ajustada por estacionalidad fue de 8.5 por ciento, mientras que la medición oficial fue de 8.0 por ciento. (Figura 1).<br>

**El índice de precios de vivienda, agua, electricidad, gas y otros combustibles fue, con diferencia, el que más aumentó en el mes con un incremento de `r cuadro1[12,7]` por ciento.** En un segundo escalón estuvieron los incrementos en restaurantes y hoteles, con `r cuadro1[19,7]` por ciento y los de salud y bebidas alcohólicas y tabaco, con `r cuadro1[14,7]` (Cuadro 1).<br>

**Los índices de precios de educación y de alimentos y bebidas no alcohólicas son los que menos aumentaron en la medición sin estacionalidad, con aumentos de `r cuadro1[18,7]` y `r cuadro1[9,7]` por ciento, respectivamente.** Estas series presentan un comportamiento estacional marcado. La diferencia entre la medición oficial es de 0.9 puntos porcentuales. El índice de prendas de vestir y calzado también muestra una diferencia de un punto porcentual entre la medición sin estacionalidad y la medición de INDEC, pero el aumento de precios de esa división se encuentra por encima de la inflación registrada en mayo, alcanzando `r cuadro1[11,7]` por ciento.<br>

**La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división alimentos y bebidas no alcohólicas explicando alrededor de 24 por ciento del `r cuadro1[2,7]` por ciento de inflación.** Las otras divisiones con incidencias importantes en el aumento del nivel general de precios sin estacionalidad fueron prendas de vestir y calzado que explicó un punto porcentual, y restaurantes y hoteles y transporte que contribuyeron con 0.9 puntos porcentuales. El índice de precios de la división alimentos y bebidas no alcohólicas contribuyó a explicar el 40 y 34 por ciento de la inflación sin estacionalidad en las regiones noroeste y noreste, respectivamente. Además en la región de Cuyo la división de alimentos y bebidas no alcohólicas explicó el 31 por ciento del incremento en el IPCse regional (Cuadro 2).<br>

**En la comparación interanual, `r meses[mes_t,1]` de `r year_t` contra `r meses[mes_t,1]` de `r year_t - 1` antes del ajuste estacional, más del 50 por ciento del aumento de `r cuadro1[2,8]` por ciento está explicado por los índices de precios de tres de las divisiones de la canasta: alimentos y bebidas no alcohólicas, prendas de vestir y calzado, y restaurantes y hoteles.**  Transporte con una incidencia interanual de 11.5 puntos porcentuales y Salud con 9.0 puntos porcentuales son las divisiones que le siguen en la explicación del aumento interanual del nivel general de precios sin estacionalidad (Cuadro 2).<br> 

**En `r meses[mes_t,1]`, la inflación subyacente, definida como el cambio porcentual en el nivel general del IPCse menos el efecto de los índices de precios de las divisiones de la canasta que incluyen bienes y servicios regulados o con alto componente impositivo, fue de `r cuadro1[21,7]` por ciento después de haber aumentado un `r cuadro1[21,6]` por ciento en `r meses[mes_t-1,1]`**  El valor de `r meses[mes_t,1]` fue impulsado por las regiones de GBA y Noroeste. En términos interanuales la inflación subyacente en el país ya superó el 120 por ciento en `r meses[mes_t,1]` (Cuadro 1).
