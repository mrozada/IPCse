...
El Índice de Precios al Consumidor (IPC) que publica mensualmente el Instituto de Estadística y Censos (INDEC) mide el cambio en los precios de una canasta de bienes y servicios adquiridos por los consumidores del país. El índice mide cambios de precios con respecto a una fecha de referencia. La fecha de referencia es diciembre de 2016 donde el IPC vale 100. El INDEC publica índices de precios, para diferentes regiones del país y para el total nacional, que no están ajustados por estacionalidad.  
