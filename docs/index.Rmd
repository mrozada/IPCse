...
### Inflación sin estacionalidad
  ...
  **En `r meses[mes_t,1]`, la inflación subyacente, definida como el cambio porcentual en el nivel general del IPCse menos el efecto de los índices de precios de las divisiones de la canasta que incluyen bienes y servicios regulados o con alto componente impositivo, fue de `r cuadro1[21,7]` por ciento después de haber aumentado un `r cuadro1[21,6]` por ciento en `r meses[mes_t-1,1]`**  El valor de `r meses[mes_t,1]` está impulsado por el valor relativamente mayor en la región patagónica. El valor más bajo de la inflación subyacente es el de la región Noreste. En términos interanuales la inflación subyacente en el país ya superó el 115 por ciento en `r meses[mes_t,1]` (Cuadro 1).
