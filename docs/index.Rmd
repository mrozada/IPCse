...
En `r meses[mes_t,1]` los factores estacionales contribuyeron a que la medición oficial de la inflación fuera `r text1` que sin estacionalidad, `r fg3t[1,2]` por ciento versus `r fg3t[1,3]` por ciento. Esta diferencia de `r abs(dif_indec_ipcse)` puntos porcentuales en la inflación con estacionalidad de `r meses[mes_t,1]` se explica fundamentalmente por el comportamiento de las divisiónes de Alimentos y bebidas no alcohólicas, Prendas de vestir y calzado y Educación, donde los factores estacionales hicieron que la medición oficial fuera entre 1 y 2.3 puntos porcentuales más baja (Figura 2). Durante los últimos 12 meses, el índice aumentó un `r cuadro1[2,8]` por ciento antes del ajuste estacional (datos oficiales de INDEC). <br>

**Durante `r meses[mes_t,1]`, el comportamiento del IPCse nivel general fue impulsado por todas las regiones.En la región de GBA se registró la mayor diferencia entre la medición oficial y el índice sin estacionalidad.Esta diferencia fue de 0.8 puntos porcentualesl.** El resto de las regiones registraron una medición sin estacionalidad mayor a la medición oficial, aunque con diferencias entre 0.3 y 0.5 puntos porcentuales. (Figura 1).<br>

**El índice de precios de Alimentos y bebidas no alcohólicas fue, con diferencia, el que más aumentó en el mes, con un incremento de `r cuadro1[9,7]` por ciento.** En un segundo escalón estuvieron los incrementos en Salud, con `r cuadro1[14,7]` por ciento y en Comunicación, con `r cuadro1[16,7]` por ciento (Cuadro 1).<br>

**El índice de precios de Vivienda, agua, gas, electricidad y otros combustibles fue el que menos aumentó en la medición sin estacionalidad, con un aumento de `r cuadro1[12,7]` por ciento.** En particular, fue el único que no superó el 10 por ciento mensual. El siguiente índice con el aumento más bajo fue el de Transporte, registrando una suba de `r cuadro1[15,7]` por ciento. Ninguno de estos dos índices presenta diferencias entre la medición sin estacionalidad y la medición de INDEC. (Figura 2).<br>

**La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división Alimentos y bebidas no alcohólicas explicando alrededor de `r round(100*cuadro2[5,8]/cuadro2[2,8],0)` por ciento del `r cuadro1[2,7]` por ciento de inflación.**  El índice de precios de la división Alimentos y bebidas no alcohólicas contribuyó a explicar el 43 y 45 por ciento de la inflación sin estacionalidad en las regiones Noroeste y Noreste, respectivamente. En la región del Gran Buenos Aires la división de alimentos y bebidas no alcohólicas explicó el 35 por ciento del incremento en el IPCse regional. Las otras divisiones con incidencias importantes en el aumento del nivel general de precios sin estacionalidad fueron las de Prendas de vestir y calzado y Salud, explicando 1.3 puntos porcentuales cada una, representando alrededor de un 10 por ciento de la inflación sin estacionalidad. (Cuadro 2).<br>
...
La Figura 4 muestra las diferencias entre las contribuciones a la tasa de inflación interanual de `r meses[mes_t,1]` del 20 por ciento de los hogares de menores y mayores ingresos. **La división de alimentos y bebidas no alcohólicas contribuyó a incrementar más la inflación para los hogares de menores ingresos en comparación con los hogares de mayores ingresos.** En particular, esta división explicó más de 36 puntos porcentuales de diferencia. En comparación, Transporte, Restaurantes y hoteles y Salud, fueron las divisiones que contribuyeron para aumentar más la tasa de inflación que enfrentó el grupo de hogares de mayores ingresos en comparación con los hogares de menores ingresos. Las divisiones de Transporte y Restaurantes y hoteles contribuyeron a reducir la brecha en la inflación enfrentada por los hogares de menores y mayores ingresos en más de 15 puntos porcentuales.
