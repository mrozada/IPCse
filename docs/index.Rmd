...
### Inflación sin estacionalidad
  ...
  **El Índice de Precios al Consumidor nacional sin estacionalidad (IPCse) aumentó un `r cuadro1[2,7]` por ciento en `r meses[mes_t,1]`, luego de haber aumentado un `r cuadro1[2,6]` por ciento en `r meses[mes_tm1,1]`.** <br>
  ...
  En `r meses[mes_t,1]` los factores estacionales contribuyeron a que la medición oficial de la inflación fuera `r text1` que sin estacionalidad, `r fg3t[1,2]` por ciento versus `r fg3t[1,3]` por ciento. Esta diferencia de `r abs(dif_indec_ipcse)` puntos porcentuales en la inflación sin estacionalidad de `r meses[mes_t,1]` se explica fundamentalmente por el comportamiento de las divisiónes de Alimentos y bebidas no alcohólicas, Bebidas alcohólicas y tabaco y Prendas de vestir y calzado, donde los factores estacionales hicieron que la medición oficial fuera entre 0.5 y 0.8 puntos porcentuales más baja (Figura 2). Durante los últimos 12 meses, el índice aumentó un `r cuadro1[2,8]` por ciento antes del ajuste estacional (datos oficiales de INDEC). <br>
  
  
  **Durante `r meses[mes_t,1]`, el comportamiento estacional del nivel general fue impulsado por las regiones Pampeana y Noroeste donde la medición oficial fue de entre 0.3 y 0.4 puntos porcentuales menor al índice sin estacionalidad, respectivamente.** El impacto fue mayor en la región Pampeana, donde la inflación ajustada por estacionalidad fue de 6.8 por ciento, mientras que la medición oficial fue de 6.4 por ciento. En el Gran Buenos Aires y en la región noreste la estacionalidad no tuvo ningún impacto. (Figura 1).<br>
  
  **El índice de precios de Comunicación fue, con diferencia, el que más aumentó en el mes con un incremento de `r cuadro1[16,7]` por ciento.** En un segundo escalón estuvieron los incrementos en Recreación y cultura, con `r cuadro1[17,7]` por ciento y los de Salud, con `r cuadro1[14,7]` por ciento (Cuadro 1).<br>
  
  **Los índices de precios de Prendas de vestir y calzado, y de Vivienda, agua, electricidad, gas y otros combustibles son los que menos aumentaron en la medición sin estacionalidad, con aumentos de `r cuadro1[11,7]` y `r cuadro1[12,7]` por ciento, respectivamente.** El índice de Prendas de vestir y calzado muestra una diferencia positiva de 0.8 puntos porcentuales entre la medición sin estacionalidad y la medición de INDEC, mientras que para Vivienda, agua, electricidad, gas y otros combustibles no hubo diferencias entre la medición de INDEC y la del IPCse. El índice de precios de la división Transporte también se encuentra dentro de los que menos aumentaron en ambas mediciones, con una suba de  `r cuadro1[15,7]` por ciento (Figura 2).<br>
  
  **La contribución más importante al dato del nivel general del IPCse de `r meses[mes_t,1]` la hizo el índice de precios de la división alimentos y bebidas no alcohólicas explicando alrededor de `r round(100*cuadro2[5,8]/cuadro2[2,8],0)` por ciento del `r cuadro1[2,7]` por ciento de inflación.** Las otras divisiones con incidencias importantes en el aumento del nivel general de precios sin estacionalidad fueron las de Salud, Recreación y cultura y Restaurantes y hoteles, explicando 0.8, 0.7 y 0.7 puntos porcentuales cada una. El índice de precios de la división alimentos y bebidas no alcohólicas contribuyó a explicar el 34 y 35 por ciento de la inflación sin estacionalidad en las regiones noreste y noroeste, respectivamente. En la región del Gran Buenos Aires la división de alimentos y bebidas no alcohólicas explicó el 26 por ciento del incremento en el IPCse regional (Cuadro 2).<br>
  
  **En la comparación interanual, `r meses[mes_t,1]` de `r year_t` contra `r meses[mes_t,1]` de `r year_t - 1` antes del ajuste estacional, más del 50 por ciento del aumento de `r cuadro1[2,8]` por ciento está explicado por los índices de precios de tres de las divisiones de la canasta: alimentos y bebidas no alcohólicas, prendas de vestir y calzado, y restaurantes y hoteles.**  Transporte con una incidencia interanual de 11.6 puntos porcentuales y Salud con 9.6 puntos porcentuales son las divisiones que le siguen en la explicación del aumento interanual del nivel general de precios sin estacionalidad (Cuadro 2).<br> 
  
  **En `r meses[mes_t,1]`, la inflación subyacente, definida como el cambio porcentual en el nivel general del IPCse menos el efecto de los índices de precios de las divisiones de la canasta que incluyen bienes y servicios regulados o con alto componente impositivo, fue de `r cuadro1[21,7]` por ciento después de haber aumentado un `r cuadro1[21,6]` por ciento en `r meses[mes_t-1,1]`**  El valor de `r meses[mes_t,1]` es una combinación de valores relativamente mayores en las regiones Noreste y Patagonia y valores relativamente más bajos en las regines Noreste y Cuyo. En términos interanuales la inflación subyacente en el país ya superó el 115 por ciento en `r meses[mes_t,1]` (Cuadro 1).
